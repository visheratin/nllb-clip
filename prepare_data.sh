...
curl -L https://google.github.io/crossmodal-3600/web-data/captions.zip > data/xm3600/captions.zip
unzip data/xm3600/captions.zip -d data/xm3600
rm data/xm3600/captions.zip
curl -L https://open-images-dataset.s3.amazonaws.com/crossmodal-3600/images.tgz > data/xm3600/images.tgz
tar -xvzf data/xm3600/images.tgz -C data/xm3600/images
